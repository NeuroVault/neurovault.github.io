...
#### We want to learn why people use NeuroVault, and how to improve it to incentivize data sharing and re-use. _Take a few minutes to tell us what the future of NeuroVault should look like!
<div>
    <style>
        .survey-button { padding: 14px; font-size: 1.5rem; background-color: rgb(0, 119, 182); color: white !important; border-radius: 8px; width: 50%; border: none; display: block; transition: 0.2s; text-decoration: none !important; text-align: center }
...
To help us, please share your thoughts with us using the survey linked below. Also, don't hesitate to get in contact to share your ideas, or if you need help accessing these data.
