...
#### Take a few minutes to [tell what the future of NeuroVault should look like](https://tally.so/forms/wLP2Oj)! 🗳️🙏
...
Note that although only 15% of collections of are associated with a published article DOI, this figure is dragged by the time it takes to publish scientific articles, and incomplete meta-data. I'll come back to this point soon.
...
This is mostly driven by a few rather large collections. Looking only at the 2,240 collections associated with a DOI and sufficient meta-data, 190 collections have single subject data while have 1844 group-level data.
